...
- 面试
categories: 算法
excerpt: 39-组合总和; 40-组合总和Ⅱ; 46-全排列; 47-全排列Ⅱ; 78-子集; 90-子集Ⅱ; 113-路径总和Ⅱ; 131-分割回文串;
---
...
## 113 - 路径总和Ⅱ
[LeetCode题目地址](https://leetcode-cn.com/problems/path-sum-ii/)
![](/img/posts_img/算法篇-回溯-113路径总和Ⅱ-1.png)
**题解**
树形图见示例
```
/**
...
[LeetCode题目地址](https://leetcode-cn.com/problems/palindrome-partitioning/)
![](/img/posts_img/算法篇-回溯-131分割回文串-1.png)
**题解**
树形图
![](/img/posts_img/算法篇-回溯-131分割回文串-2.png)
```
/**
 * @param {string} s
 * @return {string[][]}
