...
### 解构赋值
**参考文章**
[ES6阮一峰: 变量的解构赋值](https://es6.ruanyifeng.com/#docs/destructuring)
[var和let/const的区别](https://juejin.cn/post/6844903752139276301)
[近一万字的ES6语法知识点补充](https://juejin.cn/post/6844903775329583112)
**题解**
...
### Symbol
[ES6篇 - Symbol](https://wangjintian.com/2021/04/15/ES6%E7%AF%87-Symbol/)
**参考文章**
[ES6阮一峰: Symbol](https://es6.ruanyifeng.com/#docs/symbol)

### Set 和 Map 数据结构
[ES6篇 - Set & Map](https://wangjintian.com/2021/04/16/ES6%E7%AF%87-Set&Map/)
**参考文章**
[ES6阮一峰: Set 和 Map 数据结构](https://es6.ruanyifeng.com/#docs/set-map)

### Generator
**参考文章**
[ES6阮一峰: Generator 函数的语法](https://es6.ruanyifeng.com/#docs/generator)
[ES6阮一峰: Generator 函数的异步应用](https://es6.ruanyifeng.com/#docs/generator-async)
**题解**
...
```
**Generator 函数基本组成:**
1. Generator 是**普通函数**(不是构造函数); 执行 Generator 函数, 返回一个**遍历器对象/指针对象** (而不是直接运行函数体代码): `const gen = Gen()`
...
4. 注意事项:
* yield 表达式**惰性求值**, 只有当指针对象(迭代器对象)调用 next 方法将指针指向该语句时才会运算求值;
...
## 手撕代码
[GitHub - 手撕代码篇](https://github.com/jtwang7/Code-Shredded)
[各种源码实现，你想要的这里都有](https://juejin.cn/post/6844903989083897870)
### Promise(A+规范)及其常用方法
**参考文章**
[手写一款符合Promise/A+规范的Promise](http://www.fly63.com/article/detial/2071)
**题解**
自己实现的Promise: [Promise A+ -- 无注释版](https://github.com/jtwang7/Code-Shredded/blob/master/PromiseA%2B/MyPromise-NoAnnotation.js)
...
**参考文章**
[理解thunk函数的作用及co的实现](https://segmentfault.com/a/1190000012685168)
...
### async实现原理（spawn函数）
**参考文章**
[Async / Await / Generator 实现原理](https://segmentfault.com/a/1190000022638499)
**题解**
后续补充...
